...
import 'package:gardener/components/camerawesome/src/orchestrator/models/sensor_type.dart';
...
class SensorConfig {
  ...
  Future<void> switchCameraRatio() async {
    if (aspectRatio == CameraAspectRatios.ratio_max_max) {
      setAspectRatio(CameraAspectRatios.ratio_max_max);
    } else if (aspectRatio == CameraAspectRatios.ratio_16_9) {
