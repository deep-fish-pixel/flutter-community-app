...
import 'package:gardener/components/camerawesome/src/layouts/awesome/awesome_camera_layout.dart';
...
class CameraAwesomeBuilder extends StatefulWidget {
  ...
  CameraAwesomeBuilder.awesome({
    ...
    required Function(String?) onVideoCreated,
    required Function(String?) onPhotoCreated,
