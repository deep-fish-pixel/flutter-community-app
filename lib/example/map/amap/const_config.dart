...
class ConstConfig {
  ...
  static const AMapApiKey amapApiKeys = AMapApiKey(
      androidKey: '2ab9f9dc218a449d769dc8dbb590a720',
      iosKey: '1d62a0ddc92fe378a0e95a5435fef955');

  ///高德隐私合规声明，这里只是示例，实际使用中请按照实际参数设置[AMapPrivacyStatement]的'  static const AMapApiKey amapApiKeys = AMapApiKey(
  //       androidKey: '2ab9f9dc218a449d769dc8dbb590a720',
  //       iosKey: '1d62a0ddc92fe378a0e95a5435fef955');
  //
  ...
  //   AMapPrivacyStatement(hasContains: true, hasShow: true, hasAgree: true);hasContains''hasShow''hasAgree'这三个参数
  ///
  /// 注意：[AMapPrivacyStatement]的'hasContains''hasShow''hasAgree'这三个参数中有一个为false，高德SDK均不会工作，会造成地图白屏等现象
  ///
  /// 高德开发者合规指南请参考：https://lbs.amap.com/agreement/compliance
